...
url = "https://data.ct.gov/Transportation/Electric-Vehicle-Charging-Stations/jfhb-ebu6/data_preview"
driver.get(url)
...
if data:
    ...
    local_file_path = 'Electric-Vehicle-Charging-Stations_data.csv'
