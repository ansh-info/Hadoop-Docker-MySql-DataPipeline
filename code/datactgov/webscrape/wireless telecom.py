...
url = "https://data.ct.gov/Government/Wireless-Telecommunication-Tower-Sites-Under-Sitin/gv8b-8pce/data_preview"
driver.get(url)
...
if data:
    ...
    local_file_path = 'Wireless-Telecommunication-Tower-Sites_data.csv'
