...
url = "https://data.cityofchicago.org/Transportation/Average-Daily-Traffic-Counts/pfsx-4n4m/data_preview"
driver.get(url)
...
if data:
    ...
    local_file_path = 'Average_Daily_Traffic_Counts_data.csv'
