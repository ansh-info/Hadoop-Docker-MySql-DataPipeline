...
url = "https://data.cityofnewyork.us/Public-Safety/NYPD-Shooting-Incident-Data-Historic-/833y-fsy8/data_preview"
driver.get(url)
...
if data:
    ...
    local_file_path = 'NYPD-Shooting-Incident_data.csv'
