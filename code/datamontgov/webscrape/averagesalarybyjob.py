...
url = "https://data.montgomerycountymd.gov/Human-Resources/Average-Salary-by-Job-Classification/48wg-fkab/data_preview"
driver.get(url)
...
if data:
    ...
    local_file_path = 'Average-Salary-by-Job_data.csv'
