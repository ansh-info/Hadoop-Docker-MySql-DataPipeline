...
url = "https://data.montgomerycountymd.gov/Public-Safety/Crash-Reporting-Incidents-Data/bhju-22kf/data_preview"
driver.get(url)
...
if data:
    ...
    local_file_path = 'Crash-Reporting-Incidents_data.csv'
