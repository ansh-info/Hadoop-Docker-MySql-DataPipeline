...
# url = "https://data.wa.gov/Transportation/Electric-Vehicle-Population-Data/f6w7-q2d2/data_preview"
# driver.get(url)
...
#     local_file_path = 'electric_vehicle_data.csv'
...
if data:
    df = pd.DataFrame(data, columns=columns)
    local_file_path = 'Electric-Vehicle-Population_data.csv'
    df.to_csv(local_file_path, index=False)
    print(f"Data successfully saved to {local_file_path}")
else:
    print("No data found")
