...
url = "https://data.austintexas.gov/Utilities-and-City-Services/Residential-Average-Monthly-kWh-and-Bills/d9pb-3vh7/data_preview"
driver.get(url)
...
if data:
    ...
    local_file_path = 'residentialavgelecbill_data.csv'
