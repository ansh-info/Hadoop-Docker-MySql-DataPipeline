...
url = "https://data.ct.gov/Government/Telecommunications-Towers-and-Antennas/n7zh-5dbr/data_preview"
driver.get(url)
...
if data:
    ...
    local_file_path = 'Telecommunications-Towers-and-Antennas_data.csv'
