...
url = "https://data.ct.gov/Health-and-Human-Services/COVID-19-daily-and-cumulative-cases-deaths-and-tes/5dch-cm68/data_preview"
driver.get(url)
...
if data:
    ...
    local_file_path = 'COVID-19-daily-and-cumulative-cases-deaths_data.csv'
