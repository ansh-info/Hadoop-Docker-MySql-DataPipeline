...
url = "https://data.ct.gov/Health-and-Human-Services/COVID-19-Vaccinations-by-Race-Ethnicity-and-Age-AR/4z97-pa4q/data_preview"
driver.get(url)
...
if data:
    ...
    local_file_path = 'COVID-19-Vaccinations-by-Race-Ethnicity_data.csv'
